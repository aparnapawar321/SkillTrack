...
public class UserService {
    ...
    public UserDto registerUser(UserRegistrationDto registrationDto) {
        ...
        // Strictly assign ONLY the default STUDENT role for public registrations
    ...
    public UserDto updateUserRoles(Long userId, Set<Role.RoleName> roleNames) {
        ...
        // Safety check: ADMIN cannot remove ADMIN role from themselves
    ...
    public UserDto setUserMainRole(Long userId, Role.RoleName targetRole) {
        ...
        // Remove existing Student/Instructor roles
        user.getRoles().removeIf(role -> 
